...
public class MetodosComputacionales {
    ...
    public static void volTrapecio() {
        ...
        double h = (b - a) / m, k = (d - c) / n;
        double auxH = 0, auxK = 0;
        for (int i = 0; i <= n; i++) {
            double s = 0;
            auxH = 0;
            double volIntervalo = 0;
            while (s+a <= b) {
                if (s == 0 || s == m) {
                    volIntervalo += f(a + auxH, c + auxK);
                } else {
                    volIntervalo += 2 * (f(a + auxH, c + auxK));
                }
                s = s + h;
            ...
            auxK += k;
            System.out.println("vol intervalo " + i + " " + volIntervalo / 2);
            volIntervalo = (volIntervalo * h) / 2;
            if (i == 0 || i == n) {
                vol += volIntervalo;
            } else {
                vol += 2 * volIntervalo;
        ...
        vol = (vol) * (k / 2);
        System.out.println("Vol aprox: " + vol);
    }

    public static void volSimpson() {
            ...
            while (s+a <= b) {
                if (s == 0 || s == m) {
                    ...
                    volIntervalo += 2 * (f(a + auxH, c + auxK));
                        ...
                        volIntervalo += 4 * (f(a + auxH, c + auxK));
                    }
                }
                s = s + h;
                System.out.println("auxH: " + auxH);
        ...
        System.out.println("Vol aprox: " + vol);
            ...
            System.out.println("ERROR, m y n tienen que ser pares");
        }
    }
